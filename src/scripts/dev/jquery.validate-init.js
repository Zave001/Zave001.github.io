    ...
    eventForm.validate({
      ...
      errorPlacement: function(error, element) {
        if (element.attr("type") === "checkbox") {
          error.appendTo(element.closest('.form__check').find('.error-message'));
        } else {
    ...
    subscribeForm.validate({
      ...
      errorPlacement: function(error, element) {
        if (element.attr("name") === "email") {
            $('#js-errorMessage').html(error.text());
        } else if (element.attr("type") === "checkbox") {
            error.appendTo(element.closest('.subscribe__check').find('.error-message'));
        } else {
            error.insertAfter(element);
        }
      },
